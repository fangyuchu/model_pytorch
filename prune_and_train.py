...
if __name__ == "__main__":
    ...
    checkpoint=torch.load('/home/victorfang/PycharmProjects/model_pytorch/model_saved/resnet56_cifar10_DeadNeural_realdata/checkpoint/sample_num=13300000,accuracy=0.93610.tar')
