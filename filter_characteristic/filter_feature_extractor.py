...
if __name__ == "__main__":
    ...
    # train_extractor(
    #     train_data_dir='/home/victorfang/model_pytorch/data/model_saved/vgg16_extractor_static_cifar10/dead_neural',
    #     criterion=nn.MSELoss(),
    #     net_name='vgg16_bn',
    #     dataset_name='cifar10',
    #     feature_len=15,
    #     num_images=10000,
    #     special='normalization_learningrate0.01_no_sigmoid_no_bias_15features')
