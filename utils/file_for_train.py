...
if dataset == 'cifar10':
    ...
    weight_decay = {'default':5e-4,'extractor':1e-4}
    momentum = {'default':0.9,'extractor':0.9}
    batch_size=128
    #网络参数
    add_shortcut_ratio=0.9#不是这儿！！！
    ...
    if net_type =='resnet56':
        ...
        prune_ratio=0.70
        # for prune_ratio in [0.83,0.85,0.87,0.9,0.93,0.95,0.98,0.5,0.6,0.65,0.7]:
        for prune_ratio in [0.98,0.95,0.93,0.5,0.6,0.65,0.7]:
