...
if dataset == 'cifar10':
    ...
    if net_type=='resnet56':
        learning_rate = {'default': 0.1, 'extractor': 0.0001}
        exp_name='gat_resnet56_predicted_mask_and_variable_shortcut_net_mask_newinner_bn_meanstd_15'
        ...
        exp_name='gat_vgg16bn_predicted_mask_and_variable_shortcut_net_mask_newinner_meanstd_sameparam_11'
        batch_size=128
        description=exp_name+'  '+'专门训练mask,没有warmup，训练20epoch'
    ...
    if net_type =='vgg16_bn':
        exp_name='gat_vgg16bn_cifar100_net_mask_newinner_mean5gamma5reg_test'
        description=exp_name+'  '+'专门训练mask,没有warmup，训练20epoch'
        batch_size=128
    ...
    if net_type == 'mobilenet_v1':
        ...
        exp_name = 'mobilenetv1_predicted_mask_and_variable_shortcut_net_mask_newinner_1'
        description = exp_name + '  ' + '专门训练mask,没有warmup，训练20epoch'
        ...
        net_copy=mobilenet.mobilenet_v1(num_class=1000)
        ...
        #
        i = 1
        exp_name = 'mobilenetv1_predicted_mask_and_variable_shortcut_net_newinner_newtrain_' + str(
            int(prune_ratio * 100)) + '_' + str(i)
        description = exp_name + '  ' + ''
        ...
        sys.stderr = logger.Logger(os.path.join(checkpoint_path, 'log.txt'),
                                   sys.stderr)  # redirect std err, if necessary
        print(weight_decay, momentum, learning_rate, flop_expected, gradient_clip_value, i)
        checkpoint = torch.load(os.path.join(conf.root_path, 'masked_net', 'mobilenet_v1', str(i) + '.tar'),
                                map_location='cpu')
        net.load_state_dict(checkpoint['state_dict'])
    ...
    if net_type == 'resnet50':
        ...
        exp_name = 'gat_resnet50_predicted_mask_and_variable_shortcut_net_mask_newinner_bn_revised_oldreg_8'
        description = exp_name + '  ' + '专门训练mask,没有warmup，训练20epoch'
