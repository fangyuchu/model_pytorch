...
# exp_name='vgg16bn_cifar100_predicted_mask_and_variable_shortcut_net_mask_newinner_4'
# description=exp_name+'  '+'专门训练mask,没有warmup，训练20epoch'
#
...
exp_name='resnet50_predicted_mask_and_variable_shortcut_net_mask_newinner_1'
description=exp_name+'  '+'专门训练mask,没有warmup，训练20epoch'
