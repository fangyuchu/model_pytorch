...
if dataset == 'cifar10':
    ...
    if net_type=='resnet56':
        exp_name='resnet56_predicted_mask_and_variable_shortcut_net_mask_newinner_80epoch_std_8'
    ...
    if net_type =='vgg16_bn':
        exp_name='gat_vgg16bn_cifar100_predicted_mask_and_variable_shortcut_net_mask_newinner_pca_1'
        description=exp_name+'  '+'专门训练mask,没有warmup，训练20epoch'
        batch_size=128
    ...
    if net_type == 'resnet50':
        ...
        exp_name = 'gat_resnet50_predicted_mask_and_variable_shortcut_net_mask_newinner_1'
        description = exp_name + '  ' + '专门训练mask,没有warmup，训练20epoch'
