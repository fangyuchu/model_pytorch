...
def resnet20(num_classes=10):
    ...
    """
    model = CifarResNet(BasicBlock, 20, num_classes)
    return model
...
def resnet32(num_classes=10):
    ...
    Args:
      num_classes (uint): number of classes
    """
    model = CifarResNet(BasicBlock, 32, num_classes)
    return model
...
def resnet44(num_classes=10):
    ...
    Args:
      num_classes (uint): number of classes
    """
    model = CifarResNet(BasicBlock, 44, num_classes)
    return model
...
def resnet56(num_classes=10):
    ...
    Args:
      num_classes (uint): number of classes
    """
    model = CifarResNet(BasicBlock, 56, num_classes)
    return model
...
def resnet110(num_classes=10):
    ...
    Args:
      num_classes (uint): number of classes
    """
    model = CifarResNet(BasicBlock, 110, num_classes)
    return model